...
constexpr const char *IdString = "id HiveGotThis v" VERSION_STR;
...
constexpr const char *CommandString_PolicyTargets = "policytargets";
...
constexpr const int BoardWidth = 128;
constexpr const int BoardSize = 128*128;
}
